...
# =====================================================================
# 🎨 [디자인 정밀 광택 2.4.9] 채팅창 텍스트 카멜레온 버그 완벽 해결
# =====================================================================
...
if st.session_state.theme == "light":
    ...
    /* 👇 하단 채팅 입력창 구역: OS 테마 충돌(안 보이는 글씨) 완벽 방어 */
    ...
    [data-testid="stChatInput"] svg { fill: #1E1E1E !important; } /* 전송 버튼 색상 */
    ...
    [data-testid="stChatInput"] svg { fill: #FAFAFA !important; } /* 전송 버튼 색상 */
...
# =====================================================================
    ...
    with tab2:
        ...
        with st.container(height=500):
            st.markdown("""
            **[ v2.4.9 ] 2026.03.31 (화)**
            * **[20:50] 📱 UI/UX 최적화:** OS 시스템 테마와 웹 테마 설정이 정반대일 때 채팅 입력창 글씨가 보이지 않던 카멜레온 버그를 완벽하게 픽스했습니다.
